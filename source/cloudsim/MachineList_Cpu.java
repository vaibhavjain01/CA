 ...
 * @invariant $none
 */
public class MachineList_Cpu extends LinkedList<Machine_Cpu>
{
     ...
     * @post $none
     */
    public Machine_Cpu getMachine(int id)
    {
        Machine_Cpu obj = null;

        Iterator<Machine_Cpu> it = super.iterator();
        while ( it.hasNext() )
        {
            obj = it.next();
    ...
    public Machine_Cpu getMachineWithFreePE(int numPE)
    {
        ...
        while ( it.hasNext() )
        {
            ...
            if (!obj.getFailed())
            {
                PEList_Cpu myPElist = obj.getPEList();
    ...
    {
        Machine_Cpu obj = getMachine(machineID);
        if (obj == null) {
            return false;
        }
     ...
     */
    public Machine_Cpu getMachineInPos(int index)
    {
        Machine_Cpu obj = null;
        Iterator<Machine_Cpu> it = super.iterator();
        int count = 0;
