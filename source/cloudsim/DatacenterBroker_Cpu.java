 ...
 * @invariant	 $none
 */
public class DatacenterBroker_Cpu extends CloudSim {
	...
	protected DatacenterCharacteristics_Cpu[] datacenterChar;
     ...
     * @post $none
	 */
	public DatacenterBroker_Cpu(String name) throws Exception {
		super(name);
	...
	public void body(){
		...
		this.datacenterChar=new DatacenterCharacteristics_Cpu[this.datacenters];
	...
	protected void processResourceCharacteristics(Sim_event ev) {
		...
		DatacenterCharacteristics_Cpu characteristics = (DatacenterCharacteristics_Cpu) ev.get_data();
