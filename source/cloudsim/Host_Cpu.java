 ...
 * @invariant 	 $none
 */
public class Host_Cpu extends Machine_Cpu {
	 ...
	 * 
	 */
	public Host_Cpu(int id, int memory, long storage, long bw, PEList_Cpu list, MemoryProvisioner memoryProvisioner, BWProvisioner bwProvisioner, VMMAllocationPolicy allocationPolicy) {
		super(id, list);
		this.memory = memory;
