 ...
 * @invariant	$none
 */
public class DatacenterCharacteristics_Cpu extends ResourceCharacteristics_Cpu {
     ...
     * @post $none
     */
	public DatacenterCharacteristics_Cpu(String architecture, String OS,String VMM, MachineList_Cpu machineList, double timeZone,double costPerSec, double costPerMem, double costPerStorage, double costPerBw) {
