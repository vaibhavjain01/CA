 ...
 * @invariant $none
 */
public abstract class VMProvisioner_Cpu {
	
	protected MachineList_Cpu resources;
	 ...
	 * @post $none
	 */
	protected MachineList_Cpu getResources(){
	 ...
	 * @post $none
	 */
	public abstract Host_Cpu getHost(int vmID, int userID);
