...
public class ResourceCharacteristics_Cpu
{
     ...
     * @post $none
     */
    public ResourceCharacteristics_Cpu(String architecture, String OS,
                MachineList_Cpu machineList, int allocationPolicy,
     ...
     * @post $result != null
     */
    public MachineList_Cpu getMachineList() {
        return machineList_;
    }
     ...
     * @post $none
     */
    public Machine_Cpu getMachineWithFreePE() {
     ...
     * @post $none
     */
    public Machine_Cpu getMachineWithFreePE(int numPE) {
    ...
    public int getMIPSRating()
    {
        ...
        switch (allocationPolicy_)
        {
            ...
            case ResourceCharacteristics_Cpu.TIME_SHARED:
            case ResourceCharacteristics_Cpu.OTHER_POLICY_SAME_RATING:
            ...
            case ResourceCharacteristics_Cpu.SPACE_SHARED:
            case ResourceCharacteristics_Cpu.OTHER_POLICY_DIFFERENT_RATING:
                for (int i = 0; i < machineList_.size(); i++) {
                    rating += ((Machine_Cpu) machineList_.get(i)).getMIPSRating();
                }
                break;
